        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6 sm:flex-wrap items-stretch sm:items-center">
          ...
          <div className="relative sm:ml-auto sm:w-[180px]">
            ...
            <input
              ...
              placeholder="Suchen…"
              className="w-full border-[1.5px] border-gray-200 rounded-2xl py-2 pl-9 pr-3 text-[13px] text-gray-700 bg-gray-50 outline-none focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10 transition-all"
            />
          </div>
        </div>
